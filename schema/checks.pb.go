...
type CloudWatchResponse struct {
	...
	Errors    []*Tag    `protobuf:"bytes,3,rep,name=errors" json:"errors,omitempty"`
}
...
func (m *CloudWatchResponse) GetErrors() []*Tag {
	if m != nil {
		return m.Errors
	}
	return nil
...
func NewPopulatedCloudWatchResponse(r randyChecks, easy bool) *CloudWatchResponse {
	...
	if r.Intn(10) != 0 {
		v7 := r.Intn(5)
		this.Errors = make([]*Tag, v7)
		for i := 0; i < v7; i++ {
			this.Errors[i] = NewPopulatedTag(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
var fileDescriptorChecks = []byte{
	...
	,
}
