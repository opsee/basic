...
type User struct {
	...
	TeamFlags    []string                 `protobuf:"bytes,14,rep,name=team_flags,json=teamFlags" json:"team_flags,omitempty" token:"team_flags"`
}
...
func (this *User) Equal(that interface{}) bool {
	...
	if len(this.TeamFlags) != len(that1.TeamFlags) {
		return false
	}
	for i := range this.TeamFlags {
		if this.TeamFlags[i] != that1.TeamFlags[i] {
			return false
		}
	}
	return true
...
func (m *User) MarshalTo(data []byte) (int, error) {
	...
	if len(m.TeamFlags) > 0 {
		for _, s := range m.TeamFlags {
			data[i] = 0x72
			i++
			l = len(s)
			for l >= 1<<7 {
...
func NewPopulatedUser(r randyUser, easy bool) *User {
	...
	v1 := r.Intn(10)
	this.TeamFlags = make([]string, v1)
	for i := 0; i < v1; i++ {
		this.TeamFlags[i] = randStringUser(r)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedCustomer(r randyUser, easy bool) *Customer {
	...
	if r.Intn(10) != 0 {
		v3 := r.Intn(5)
		this.BastionStates = make([]*BastionState, v3)
		for i := 0; i < v3; i++ {
...
func (m *User) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			...
			m.TeamFlags = append(m.TeamFlags, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorUser = []byte{
	...
	,
}
