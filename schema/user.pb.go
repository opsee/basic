...
type Team struct {
	...
	StripeId       string          `protobuf:"bytes,7,opt,name=stripe_id,json=stripeId,proto3" json:"stripe_id,omitempty"`
}
...
func (this *Team) Equal(that interface{}) bool {
	...
	if this.StripeId != that1.StripeId {
		return false
	}
	return true
}
	...
	GraphQLTeamType = github_com_graphql_go_graphql.NewObject(github_com_graphql_go_graphql.ObjectConfig{
		...
		Fields: (github_com_graphql_go_graphql.FieldsThunk)(func() github_com_graphql_go_graphql.Fields {
			return github_com_graphql_go_graphql.Fields{
				...
				"stripe_id": &github_com_graphql_go_graphql.Field{
					Type:        github_com_graphql_go_graphql.String,
					Description: "",
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						obj, ok := p.Source.(*Team)
						...
						if ok {
							...
							return face.StripeId, nil
						}
						return nil, fmt.Errorf("field stripe_id not resolved")
					},
				},
			}
		}),
...
func (m *Team) MarshalTo(data []byte) (int, error) {
	...
	if len(m.StripeId) > 0 {
		data[i] = 0x3a
		i++
		i = encodeVarintUser(data, i, uint64(len(m.StripeId)))
		i += copy(data[i:], m.StripeId)
	}
	return i, nil
}
...
func NewPopulatedTeam(r randyUser, easy bool) *Team {
	...
	this.StripeId = randStringUser(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
var fileDescriptorUser = []byte{
	...
	,
}
