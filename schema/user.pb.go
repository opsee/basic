...
type Team struct {
	...
	TrialStart             *opsee_types.Timestamp `protobuf:"bytes,13,opt,name=trial_start,json=trialStart" json:"trial_start,omitempty"`
	TrialEnd               *opsee_types.Timestamp `protobuf:"bytes,14,opt,name=trial_end,json=trialEnd" json:"trial_end,omitempty"`
...
func (m *Team) GetTrialStart() *opsee_types.Timestamp {
	if m != nil {
		return m.TrialStart
	}
	return nil
...
func (m *Team) GetTrialEnd() *opsee_types.Timestamp {
	if m != nil {
		return m.TrialEnd
	}
	return nil
...
func (this *Team) Equal(that interface{}) bool {
	...
	if !this.TrialStart.Equal(that1.TrialStart) {
		return false
	}
	if !this.TrialEnd.Equal(that1.TrialEnd) {
		return false
	}
	...
	GraphQLTeamType = github_com_graphql_go_graphql.NewObject(github_com_graphql_go_graphql.ObjectConfig{
		...
		Fields: (github_com_graphql_go_graphql.FieldsThunk)(func() github_com_graphql_go_graphql.Fields {
			return github_com_graphql_go_graphql.Fields{
				...
				"trial_start": &github_com_graphql_go_graphql.Field{
					Type:        github_com_opsee_protobuf_plugin_graphql_scalars.Timestamp,
					Description: "",
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						obj, ok := p.Source.(*Team)
						if ok {
							if obj.TrialStart == nil {
								return nil, nil
							}
							return obj.GetTrialStart(), nil
						}
						inter, ok := p.Source.(TeamGetter)
						if ok {
							face := inter.GetTeam()
							...
							if face.TrialStart == nil {
								return nil, nil
							}
							return face.GetTrialStart(), nil
						}
						return nil, fmt.Errorf("field trial_start not resolved")
					},
				},
				"trial_end": &github_com_graphql_go_graphql.Field{
					...
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						...
						if ok {
							...
							if face.TrialEnd == nil {
								return nil, nil
							}
							return face.GetTrialEnd(), nil
						}
...
func (m *Team) MarshalTo(data []byte) (int, error) {
	...
	if m.TrialStart != nil {
		data[i] = 0x6a
		i++
		i = encodeVarintUser(data, i, uint64(m.TrialStart.Size()))
		n8, err := m.TrialStart.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.TrialEnd != nil {
		data[i] = 0x72
		i++
		i = encodeVarintUser(data, i, uint64(m.TrialEnd.Size()))
		n9, err := m.TrialEnd.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func NewPopulatedTeam(r randyUser, easy bool) *Team {
	...
	if r.Intn(10) != 0 {
		this.TrialStart = opsee_types.NewPopulatedTimestamp(r, easy)
	}
	if r.Intn(10) != 0 {
		this.TrialEnd = opsee_types.NewPopulatedTimestamp(r, easy)
	}
...
func (m *Team) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			if m.TrialStart == nil {
				m.TrialStart = &opsee_types.Timestamp{}
			}
		...
		case 14:
			...
			if m.TrialEnd == nil {
				m.TrialEnd = &opsee_types.Timestamp{}
			}
...
var fileDescriptorUser = []byte{
	...
	,
}
